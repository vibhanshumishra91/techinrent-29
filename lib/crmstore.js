...
const COLLECTIONS = { leads: 'crm:leads', reports: 'crm:reports', attendance: 'crm:attendance', activity: 'crm:activity', partners: 'crm:partners', posts: 'crm:posts', leaves: 'crm:leaves' };
...
module.exports = { list, get, put, patch, del, putMany, rid, configured: !!(url && token) };
